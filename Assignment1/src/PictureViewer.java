...
//            if(new PictureViewer().getClass().getResource(fileName)==null)
//            {
//            	System.out.println(new PictureViewer().getClass().getResource("."));
//            	System.out.println("The file is null");
//            	return;
//            }
            ImageIcon imicon = new ImageIcon( new PictureViewer().getClass().getResource(fileName));
